...
public class ChanceDeck extends CardDeck {
	...
	ChanceDeck () {
		...
		cards.add(new Card(CHANCE_CARD,pan.MovementCards(),ACT_GO_FORWARD,WorldBuilder.POS_PALL_MALL));
		...
		// Payments
		cards.add(new Card(CHANCE_CARD,pan.RewardCard() + " " + UI.CURRENCY_SYMBOL + "150.",ACT_RECEIVE,150));
		cards.add(new Card(CHANCE_CARD,pan.RewardCard() +  UI.CURRENCY_SYMBOL + "100.",ACT_RECEIVE,100));
		cards.add(new Card(CHANCE_CARD,pan.RewardCard()+ " " + UI.CURRENCY_SYMBOL + "50.",ACT_RECEIVE,50));
