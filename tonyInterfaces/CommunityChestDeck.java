...
public class CommunityChestDeck extends CardDeck {
	...
	CommunityChestDeck () {
		...
		// Movement
		cards.add(new Card(COMMUNITY_CHEST,pan.MovementCards()+"Forward to Go",ACT_GO_FORWARD,WorldBuilder.POS_GO));
		...
		cards.add(new Card(COMMUNITY_CHEST,pan.RewardCard() + " the opportunity to collect " + UI.CURRENCY_SYMBOL + "10 from each player",ACT_GIFTS,10));
