...
/**
 * Monopoly bot for the team SudoAptGetRekt
 *
 * Authors:
 * - Edwin Lebreton
 * - Michael Mullen 
...
//                //System.out.println(!property.isMortgaged()+" sudo");
    ...
    private boolean canBuy() {
        ...
        //System.out.println("prop to buy" + property.getIdentifier());
    ...
    private String maybeBuild() {
        ...
        //System.out.println(player.getProperties()+" "+bestSite.getColourGroup().getMembers());
...
//        	//System.out.println(!property.isMortgaged()+" sudo 2");
            if (!property.isMortgaged()) {
